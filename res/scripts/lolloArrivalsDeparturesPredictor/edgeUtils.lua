...
local matrixUtils = require('lolloArrivalsDeparturesPredictor.matrix')
local quadrangleUtils = require('lolloArrivalsDeparturesPredictor.quadrangleUtils')
...
helper.track.getNearestEdgeIdStrict = function(transf)
    ...
    --     return baseEdgeIds[1]
        ...
        --     end
        -- end
        print('lolloArrivalsDeparturesPredictor WARNING track.getNearestEdgeIdStrict falling back')
        return baseEdgeIds[1] -- fallback
    end
end
