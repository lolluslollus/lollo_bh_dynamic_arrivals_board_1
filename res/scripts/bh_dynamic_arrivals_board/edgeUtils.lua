...
local matrixUtils = require('bh_dynamic_arrivals_board.matrix')
local quadrangleUtils = require('bh_dynamic_arrivals_board.quadrangleUtils')
...
helper.track.getNearestEdgeIdStrict = function(transf)
    ...
    --     return baseEdgeIds[1]
        ...
        --     end
        -- end
        print('bh_dynamic_arrivals_board WARNING track.getNearestEdgeIdStrict falling back')
        return baseEdgeIds[1] -- fallback
    end
end
